...
if error_code == '':
    print(f"{riotid} :","ไอดีไทย")
elif error_code == -200:
    print(f"{riotid} :","ไอดีต่างประเทศ")
elif error_code == -100:
    print(f"{riotid} :","ไม่พบไอดีนี้")
elif error_code == -222:
    print(f"{riotid} :","#ส่ไอดีไม่ครบ")
else:
    print("Error Code:","Error code not recognized")